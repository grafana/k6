...
require (
	...
	github.com/PuerkitoBio/goquery v1.9.3 // FIXME: update to v1.10.x only when k6 uses go 1.23 and above
	...
	go.opentelemetry.io/otel v1.29.0 // FIXME: update to v1.30.x only when k6 uses go 1.22 and above

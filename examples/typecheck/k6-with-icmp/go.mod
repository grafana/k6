module go.k6.io/k6/examples/typecheck/k6-with-icmp
...
require (
	go.k6.io/k6/examples/typecheck/xk6-icmp v0.0.0
...
require (
	...
	github.com/grafana/xk6-icmp v0.3.3 // indirect
...
replace go.k6.io/k6/examples/typecheck/xk6-icmp => ../xk6-icmp

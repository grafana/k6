...
// Useful to verify that the full-page screenshots adapt their width
// to the context's configured device dimensions.
//
...
//
// Expected pattern: action-tagged shots whose width matches the
// iPhone X logical viewport (375 logical pixels, scaled up by the
// device's deviceScaleFactor). The full-page capture means height
// reflects the scrollable content length, not the device viewport.

...
export const options = {
  ...
  ext: {
    chaos: {
      hypothesis: `
        When we inject a pod failure into a deployment, the performance of
        our system will not be degraded by more than 10% while under normal load.
      `,
    },
  },
};

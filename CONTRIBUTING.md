...
1. Find an issue you'd like to fix. If there is none already, or you'd like to add a feature, please open one and we can talk about how to do it. Out of respect for your time, please start a discussion regarding any bigger contributions either in the `#contributors` channel of the k6 slack or in the Github Issue **before** you get started on the implementation.

...
- [ ] Go through the potential [dependencies updates](/grafana/k6/tree/master/Dependencies.md) and create a dedicated PR if any of them is relevant to this release.
...
- [ ] Open a separate pull-request for bumping [the k6 Go project's version](/grafana/k6/tree/master/lib/consts/consts.go#L11-L12).
...
- [ ] Merge the PR bumping [the k6 Go project's version](/grafana/k6/tree/master/lib/consts/consts.go#L11-L12).

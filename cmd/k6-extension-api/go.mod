module go.k6.io/k6-extension-api/cmd/k6-extension-api
...
require (
	...
	github.com/grafana/xk6-sql-driver-clickhouse v0.0.0
	github.com/grafana/xk6-sql-driver-mysql v0.0.0
...
replace github.com/grafana/xk6-disruptor => ../../extensions-corpus/grafana/xk6-disruptor
...
replace github.com/grafana/xk6-sql-driver-clickhouse => ../../extensions-corpus/grafana/xk6-sql-driver-clickhouse

replace github.com/grafana/xk6-sql-driver-mysql => ../../extensions-corpus/grafana/xk6-sql-driver-mysql

replace github.com/grafana/xk6-sql-driver-postgres => ../../extensions-corpus/grafana/xk6-sql-driver-postgres

replace github.com/grafana/xk6-sql-driver-sqlserver => ../../extensions-corpus/grafana/xk6-sql-driver-sqlserver

...
// checks if the LoadTestListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoadTestListResponse{}

// LoadTestListResponse struct for LoadTestListResponse
type LoadTestListResponse struct {
	// List of the resulting values.
	Value []LoadTestApiModel `json:"value"`
...
type _LoadTestListResponse LoadTestListResponse
...
func (o LoadTestListResponse) MarshalJSON() ([]byte, error) {
...
func (o LoadTestListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *LoadTestListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLoadTestListResponse := _LoadTestListResponse{}

	err = json.Unmarshal(data, &varLoadTestListResponse)

	if err != nil {
		return err
	}

	*o = LoadTestListResponse(varLoadTestListResponse)
...
type NullableLoadTestListResponse struct {
	value *LoadTestListResponse
	isSet bool
}

func (v NullableLoadTestListResponse) Get() *LoadTestListResponse {
	return v.value
}

func (v *NullableLoadTestListResponse) Set(val *LoadTestListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLoadTestListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLoadTestListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoadTestListResponse(val *LoadTestListResponse) *NullableLoadTestListResponse {
	return &NullableLoadTestListResponse{value: val, isSet: true}
}

func (v NullableLoadTestListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoadTestListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

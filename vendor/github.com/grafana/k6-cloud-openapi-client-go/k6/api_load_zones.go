...
func (r *ApiLoadZonesAllowedProjectsRetrieveRequest) Execute() (*AllowedProjectsListApiModel, *http.Response, error) {
	return r.ApiService.LoadZonesAllowedProjectsRetrieveExecute(r)
}
...
func (a *LoadZonesAPIService) LoadZonesAllowedProjectsRetrieveExecute(r *ApiLoadZonesAllowedProjectsRetrieveRequest) (*AllowedProjectsListApiModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/cloud/v6/load_zones/{id}/allowed_projects"
...
func (r *ApiLoadZonesAllowedProjectsUpdateRequest) UpdateAllowedProjectsListApiModel(updateAllowedProjectsListApiModel *UpdateAllowedProjectsListApiModel) *ApiLoadZonesAllowedProjectsUpdateRequest {
	r.updateAllowedProjectsListApiModel = updateAllowedProjectsListApiModel
	return r
}

func (r *ApiLoadZonesAllowedProjectsUpdateRequest) Execute() (*AllowedProjectsListApiModel, *http.Response, error) {
	return r.ApiService.LoadZonesAllowedProjectsUpdateExecute(r)
}
...
func (a *LoadZonesAPIService) LoadZonesAllowedProjectsUpdateExecute(r *ApiLoadZonesAllowedProjectsUpdateRequest) (*AllowedProjectsListApiModel, *http.Response, error) {
	...
	if r.updateAllowedProjectsListApiModel == nil {
		return localVarReturnValue, nil, reportError("updateAllowedProjectsListApiModel is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "X-Stack-Id", r.xStackId, "simple", "")
	// body params
	localVarPostBody = r.updateAllowedProjectsListApiModel
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// Filter results by k6 load zone ID (exact match).
func (r *ApiLoadZonesListRequest) K6LoadZoneId(k6LoadZoneId string) *ApiLoadZonesListRequest {
	r.k6LoadZoneId = &k6LoadZoneId
	return r
}

func (r *ApiLoadZonesListRequest) Execute() (*LoadZonesListApiModel, *http.Response, error) {
	return r.ApiService.LoadZonesListExecute(r)
}

/*
LoadZonesList List all load zones.
...
func (a *LoadZonesAPIService) LoadZonesListExecute(r *ApiLoadZonesListRequest) (*LoadZonesListApiModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/cloud/v6/load_zones"
	...
	if r.k6LoadZoneId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "k6_load_zone_id", r.k6LoadZoneId, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r *ApiProjectsAllowedLoadZonesRetrieveRequest) Execute() (*AllowedLoadZonesListApiModel, *http.Response, error) {
	return r.ApiService.ProjectsAllowedLoadZonesRetrieveExecute(r)
}
...
func (a *LoadZonesAPIService) ProjectsAllowedLoadZonesRetrieveExecute(r *ApiProjectsAllowedLoadZonesRetrieveRequest) (*AllowedLoadZonesListApiModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/cloud/v6/projects/{id}/allowed_load_zones"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r *ApiProjectsAllowedLoadZonesUpdateRequest) UpdateAllowedLoadZonesListApiModel(updateAllowedLoadZonesListApiModel *UpdateAllowedLoadZonesListApiModel) *ApiProjectsAllowedLoadZonesUpdateRequest {
	r.updateAllowedLoadZonesListApiModel = updateAllowedLoadZonesListApiModel
	return r
}

func (r *ApiProjectsAllowedLoadZonesUpdateRequest) Execute() (*AllowedLoadZonesListApiModel, *http.Response, error) {
	return r.ApiService.ProjectsAllowedLoadZonesUpdateExecute(r)
}
...
func (a *LoadZonesAPIService) ProjectsAllowedLoadZonesUpdateExecute(r *ApiProjectsAllowedLoadZonesUpdateRequest) (*AllowedLoadZonesListApiModel, *http.Response, error) {
	...
	if r.updateAllowedLoadZonesListApiModel == nil {
		return localVarReturnValue, nil, reportError("updateAllowedLoadZonesListApiModel is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "X-Stack-Id", r.xStackId, "simple", "")
	// body params
	localVarPostBody = r.updateAllowedLoadZonesListApiModel
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}

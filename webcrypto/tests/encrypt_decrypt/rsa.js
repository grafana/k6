...
// This file contains an adaptation of the encrypt_decrypt/rsa.js
...
// https://github.com/web-platform-tests/wpt/blob/a0c68e169123b1ab01a844533c8d6a98d1aaa156/WebCryptoAPI/encrypt_decrypt/rsa.js
function run_test() {
           ...
           promise_test(function(test) {
               ...
               .then(function(ciphertext) {
                   ...
                   .then(function(result) {
                       ...
                       assert_unreached("decrypt error for test " + vector.name + ": " + err.message + "'" + JSON.stringify(err));
                   });
               })
               .then(function(priorCiphertext) {
                   ...
                   .then(function(ciphertext) {
                       ...
                       assert_unreached("second time encrypt error for test " + vector.name + ": '" + err.message + "'"  + JSON.stringify(err));
                   });
               }, function(err) {
                   assert_unreached("decrypt error for test " + vector.name + ": '" + err.message + "'" + JSON.stringify(err));
               });

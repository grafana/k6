...
- [#5703](https://github.com/grafana/k6/pull/5703) Uses Go's `synctest` package within `lib/executor` tests for virtualized time, improving test determinism.
- [#5818](https://github.com/grafana/k6/pull/5818) Uses Go's `synctest` package within eventloop and timer tests.

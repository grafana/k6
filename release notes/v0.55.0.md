...
- [browser#1461](https://github.com/grafana/xk6-browser/pull/1461) Enhance `waitForSelector` error message to better reflect why a selector doesn't resolve to an element.

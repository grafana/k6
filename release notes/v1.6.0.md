...
- Cloud commands now support configurable default stacks.
...
The websockets module source code has been graduated as a stable module and it is now importable via `k6/websockets` path.
...
Simply update your import statement to migrate:

...
- Cloud commands now support configurable default Grafana Cloud stacks.
...
In addition, k6 now supports a manifest that will set a default version for any dependency that doesn't have one set. It does not request any dependency, just sets versions for dependencies with "*" as the constraint.
...
- [#5590](https://github.com/grafana/k6/pull/5590) Adds deprecation notice for the `stack` parameter in Cloud CLI commands. Users should configure their default stack during login instead.
...
- [#5594](https://github.com/grafana/k6/pull/5594) Returns an error when both project ID and stack ID are specified for Cloud commands, preventing ambiguous configuration.
...
- [#5603](https://github.com/grafana/k6/pull/5603) Upgrades Alpine images in the Dockerfile to the latest versions for security and performance improvements.
...
A huge thank you to the external contributors who helped during this release: @LBaronceli, @baeseokjae, @chojs23, @pkalsi97, @weillercarvalho, @ariasmn, @rahulmedicharla and @shota3506! 🙏

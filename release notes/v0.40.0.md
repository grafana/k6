...
TODO exemplify a future breaking change of using `exports.somethign = 5` and the `import`/`export` syntax in the same file. Also recommend not mixing them at all if possible.

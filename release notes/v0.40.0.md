...
The native ESM support is coming. There is both a somewhat functioning (but still lacking in some areas) PoC [PR to k6](https://github.com/grafana/k6/pull/2563) and a branch that will (hopefully) soon become a PR to goja to add the support there.

...
The secret management system now supports URL-based secret sources, allowing k6 to fetch secrets from HTTP endpoints. This enables seamless integration with any HTTP-based secret management service, including HashiCorp Vault, AWS Secrets Manager, Azure Key Vault, and custom in-house solutions.
...
This approach provides a flexible way to manage sensitive credentials without embedding them in test scripts or environment variables.

...
- a number of bugfixes and other small improvements
...
' [#4921](https://github.com/grafana/k6/pull/4921), [#5013](https://github.com/grafana/k6/pull/5013) Removes the requirement for GCK6 authentication for using the automatic extension resolution, and enables the feature for local execution (i.e., the `k6 run` command).
- [#4922](https://github.com/grafana/k6/pull/4922) Supports running tests using community extensions.
- [#5039](https://github.com/grafana/k6/pull/5039) Disable automatic resolution when start custom binaries, including for old versions of k6.

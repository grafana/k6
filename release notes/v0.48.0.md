...
- [browser#1077](https://github.com/grafana/xk6-browser/pull/1077) Fixes `browserContext.clearPermissions` so it no longer panics and actually performs the clear permissions action in the chrome browser.

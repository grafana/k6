...
We're happy to announce our work on a new, upcoming, dashboard feature. Based on the [xk6-dashboard](https://github.com/grafana/xk6-dashboard) extension, this upcoming feature will enable you to visualize your test load test runs and their results in your web browser, in real-time. The k6 maintainers team is starting the work towards its integration into the core of k6, and we're aiming to release it in the next couple of releases.

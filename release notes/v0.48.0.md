...
- Remote modules should be specified with full URLs.
- Metrics names now need to conform to both OpenTelemetry (OTEL) and Prometheus name requirements.
...
This release contains several breaking changes. Most of them should not heavily impact existing users, and have a clear process of migration.
...
- [#3446](https://github.com/grafana/k6/pull/3446) A log tokenizer moved to `lib/strvals` package.

...
- [#4234](https://github.com/grafana/k6/pull/5234) Updates renovate config.
...
- [#5216](https://github.com/grafana/k6/pull/5216) refactors `TestPageOnResponse` to fail fast on errors.

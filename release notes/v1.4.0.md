...
- [#5164](https://github.com/grafana/k6/pull/5164) OpenTelemetry output now exports rate metrics as a single counter with `condition=zero|nonzero` labels instead of separate metrics.
- `#pr`, `<small_break_2>`

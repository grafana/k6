...
- JS: Added a way for JS modules to have per VU initialization and object. This can also be used by xk6 modules by implementing [`github.com/liuxd6825/k6server/js/modules#HasModuleInstancePerVU`](https://pkg.go.dev/github.com/liuxd6825/k6server/js/modules#HasModuleInstancePerVU). (Part of [#1911](https://github.com/k6io/k6/pull/1911))

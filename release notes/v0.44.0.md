...
- A new experiment `webcrypto` module implementing (partially) the [Web Crypto API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API) specification.
...
- [browser#838](https://github.com/grafana/xk6-browser/pull/838) Removed first meaningful paint metric. This metric is being deprecated across all the browsers, so we've removed it.

## New features

### A new experimental module implementing the Web Crypto API specification [#2884](https://github.com/grafana/k6/pull/3007)

This release includes a new experiment `webcrypto` module implementing (partially) the [Web Crypto API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API) specification in k6.
...
- [browser#776](https://github.com/grafana/xk6-browser/pull/776) Fixed a test for preset flags for chrome on darwin based systems.
- [browser#782](https://github.com/grafana/xk6-browser/pull/782), [browser#783](https://github.com/grafana/xk6-browser/pull/783), [browser#826](https://github.com/grafana/xk6-browser/pull/826) Fixed and refactored the mapping.
...
- [browser#798](https://github.com/grafana/xk6-browser/pull/798), [browser#799](https://github.com/grafana/xk6-browser/pull/799) Added more tests for the mapping layer.
...
- [browser#819](https://github.com/grafana/xk6-browser/pull/819) Browser.Launch now transitions to Browser.Connect when a CDP url is provided in an env var.

...
This release includes [xk6-webcrypto](https://github.com/grafana/xk6-webcrypto) as an experimental module. This is a work in progress implementation of the [Web Crypto API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API) specification for k6.

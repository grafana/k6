...
Some highlights from the browser module are:
...
- [xk6-browser#844](https://github.com/grafana/xk6-browser/pull/844) Removed the exported `version` param from the root module. Users should from now on reference the k6 version instead of the browser module version.
...
### Web Vitals are now natively supported by the browser module [xk6-browser#836](https://github.com/grafana/xk6-browser/pull/836) [xk6-browser#847](https://github.com/grafana/xk6-browser/pull/847)
...
- [xk6-browser#843](https://github.com/grafana/xk6-browser/pull/843) Removed the build step from github actions. From this release onwards, no new standalone xk6-browser binaries will be built and available from the [releases](https://github.com/grafana/xk6-browser/releases) section. The latest version of the browser module will be available in the k6 binary which can be found in the [k6 releases](https://github.com/grafana/k6/releases) page.
...
- [xk6-browser#782](https://github.com/grafana/xk6-browser/pull/782), [xk6-browser#783](https://github.com/grafana/xk6-browser/pull/783), [xk6-browser#826](https://github.com/grafana/xk6-browser/pull/826) Fixed and refactored the mapping.
- [xk6-browser#797](https://github.com/grafana/xk6-browser/pull/797), [xk6-browser#832](https://github.com/grafana/xk6-browser/pull/832) Fixed multi browser close.
- [xk6-browser#796](https://github.com/grafana/xk6-browser/pull/796), [xk6-browser#810](https://github.com/grafana/xk6-browser/pull/810) Refactored `browserContext.SetExtraHTTPHeaders` to work with errors and ErrFatal.
- [xk6-browser#798](https://github.com/grafana/xk6-browser/pull/798), [xk6-browser#799](https://github.com/grafana/xk6-browser/pull/799) Added more tests for the mapping layer.
...
- [xk6-browser#821](https://github.com/grafana/xk6-browser/pull/821), [xk6-browser#824](https://github.com/grafana/xk6-browser/pull/824), [xk6-browser#830](https://github.com/grafana/xk6-browser/pull/830) Upgraded dependencies and fixed breaking changes.

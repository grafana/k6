...
- add `clear` functionality to the `locator` classes within the browser module
...
Activate this feature using the environment variable K6_WEB_DASHBOARD=true. For this initial release, the dashboard is not enabled by default to allow users to opt into this new experience as it continues to evolve.
...
- [#3543](https://github.com/grafana/k6/pull/3543) switches documentation URLs to the `grafana.com/docs/k6/latest/`.

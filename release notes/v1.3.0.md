...
- Browser module gets `locator.locator`, `locator.contentFrame`, `locator.boundingBox`, `locator.filter`, `locator.getBy*`, `frame.getBy*`, `FrameLocator.locator`, `Framelocator.getBy*`, and `page.waitForResponse`. It now supports chainable 

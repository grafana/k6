...
- [#4567](https://github.com/grafana/k6/pull/4567), [#4558](https://github.com/grafana/k6/pull/4558) Fixes race conditions with the browser module's `ElementHandle`, `Mouse`, and `Keyboard`.

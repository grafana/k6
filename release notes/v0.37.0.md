...
With this change k6 started to return an error message on thresholds that wouldn't have been evaluated correctly, instead of just silently ignoring them.
...
export let options = {
    thresholds: {
        "http_req_duration": [
            ...
            "throw new Error('wat')",
            // test is not a valid aggregation metric
            "foo>500",
        ],
    },
};

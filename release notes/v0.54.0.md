...
Check out [the `check` utility function's documentation](https://grafana.com/docs/k6/next/javascript-api/jslib/utils/check/) for more information on how to use it.

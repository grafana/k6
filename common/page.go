...
func (p *Page) Context() BrowserContextAPI {
	return p.browserCtx
}
...
func (p *Page) MainFrame() api.FrameAPI {
...
func (p *Page) Query(selector string) (api.ElementHandleAPI, error) {
...
func (p *Page) QueryAll(selector string) ([]api.ElementHandleAPI, error) {
...
func (p *Page) Video() api.VideoAPI {
...
func (p *Page) WaitForRequest(_, _ goja.Value) api.RequestAPI {
...
func (p *Page) WaitForSelector(selector string, opts goja.Value) (api.ElementHandleAPI, error) {

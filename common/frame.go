...
func (f *Frame) EvaluateHandle(pageFunc goja.Value, args ...goja.Value) (handle api.JSHandleAPI, _ error) {
...
func (f *Frame) FrameElement() (api.ElementHandleAPI, error) {
...
func (f *Frame) Locator(selector string, opts goja.Value) api.LocatorAPI {
...
func (f *Frame) Query(selector string) (api.ElementHandleAPI, error) {
...
func (f *Frame) QueryAll(selector string) ([]api.ElementHandleAPI, error) {
...
func (f *Frame) WaitForSelector(selector string, opts goja.Value) (api.ElementHandleAPI, error) {
...
type frameExecutionContext interface {
	...
	// functions.
	getInjectedScript(apiCtx context.Context) (api.JSHandleAPI, error)
	...
	EvalHandle(apiCtx context.Context, js goja.Value, args ...goja.Value) (api.JSHandleAPI, error)

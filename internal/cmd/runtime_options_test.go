...
func TestRuntimeOptions(t *testing.T) {
	...
	var (
		...
		defaultDisableNewMachineReadableSummary = null.NewBool(true, false)
	)
	...
	runtimeOptionsTestCases := map[string]runtimeOptionsTestCase{
		"empty env": {
			...
			expRTOpts: lib.RuntimeOptions{
				...
				DisableNewMachineReadableSummary: defaultDisableNewMachineReadableSummary,
			},
		},
		...
		"traces output default": {
			...
			expRTOpts: lib.RuntimeOptions{
				...
				SummaryMode:                      defaultSummaryMode,
				DisableNewMachineReadableSummary: null.NewBool(true, false),
			},
		},

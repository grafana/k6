...
const (
	...
	// browser module. Recognised values:
	//   "actions"  capture after every browser API call (on success) and
	//              on failure.
	//   "failures" capture only when a browser API call fails.
	// Unset or unknown values disable the feature.

...
func (p *Page) GetByLabel(label string, opts *GetByAltTextOptions) *Locator {
	p.logger.Debugf("Page:GetByRole", "sid:%s role: %q opts:%+v", p.sessionID(), label, opts)

	return p.MainFrame().GetByLabel(label, opts)
}

// GetByPlaceholder creates and returns a new locator for this page (main frame) based on the alt attribute text.
func (p *Page) GetByPlaceholder(placeholder string, opts *GetByAltTextOptions) *Locator {
	p.logger.Debugf("Page:GetByPlaceholder", "sid:%s role: %q opts:%+v", p.sessionID(), placeholder, opts)

	return p.MainFrame().GetByPlaceholder(placeholder, opts)
}

// GetByTitle creates and returns a new locator for this page (main frame) based on the alt attribute text.
func (p *Page) GetByTitle(title string, opts *GetByAltTextOptions) *Locator {
	p.logger.Debugf("Page:GetByTitle", "sid:%s role: %q opts:%+v", p.sessionID(), title, opts)
...
// GetByText creates and returns a new locator for this page (main frame) based on the alt attribute text.
func (p *Page) GetByText(text string, opts *GetByAltTextOptions) *Locator {
	p.logger.Debugf("Page:GetByText", "sid:%s role: %q opts:%+v", p.sessionID(), text, opts)

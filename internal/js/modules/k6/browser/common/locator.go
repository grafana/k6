...
func (l *Locator) First() *Locator {
	return NewLocator(l.ctx, l.opts, l.selector+" >> nth=0", l.frame, l.log)
}
...
func (l *Locator) Last() *Locator {
	return NewLocator(l.ctx, l.opts, l.selector+" >> nth=-1", l.frame, l.log)
}

// Nth will return the nth child of the element matching the locator's
// selector.
func (l *Locator) Nth(nth int) *Locator {
	return NewLocator(l.ctx, l.opts, l.selector+" >> nth="+strconv.Itoa(nth), l.frame, l.log)
}

...
func mapRequest(vu moduleVU, r common.RequestAPI) mapping {
	rt := vu.Runtime()
	maps := mapping{
...
func mapResponse(vu moduleVU, r api.ResponseAPI) mapping {
	if r == nil {
		return nil
	}
	rt := vu.Runtime()
...
//
//nolint:funlen
func mapElementHandle(vu moduleVU, eh common.ElementHandleAPI) mapping {
	maps := mapping{
...
//
//nolint:funlen
func mapPage(vu moduleVU, p common.PageAPI) mapping {
	rt := vu.Runtime()
	maps := mapping{
